...
from healthcare.conversion.conversion_service import ConversionResult
...
class TestUploadConversionIntegration:
    ...
    async def test_complete_upload_conversion_pipeline(
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch(
                "healthcare.upload.routes.PDFConversionService"
                ...
                from healthcare.upload.routes import upload_pdf
