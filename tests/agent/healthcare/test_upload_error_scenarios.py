...
class TestUploadErrorScenarios:
    ...
    def test_check_duplicate_database_error(self):
        ...
        self.mock_db_service.get_session.return_value.__enter__.return_value = mock_session
    ...
    async def test_upload_pdf_user_creation_fails(self):
        ...
        self.mock_db_service.get_or_create_user.side_effect = Exception("Database error")
    ...
    def test_get_upload_stats_with_permission_error(self):
        ...
        try:
            ...
            assert "error" in stats or (stats["total_files"] == 0 and stats["total_size"] == 0)
        finally:
            # Restore permissions for cleanup
            upload_dir.chmod(0o755)
