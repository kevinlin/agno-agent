...
from agent.healthcare.main import create_app, add_routes
...
class TestHealthCheckEndpoint:
    ...
    def test_health_check_all_services_healthy(
        self, client, mock_config, mock_db_service, mock_embedding_service, mock_search_service
    ):
    ...
    def test_health_check_response_format(
        ...
        for service in expected_services:
            ...
            assert "status" in services[service], f"Missing status for service: {service}"
