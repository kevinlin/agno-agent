...
"""
    ...
    def convert_pdf_to_markdown(self, file_id: str) -> ConversionResult:
        ...
        try:
            ...
            logger.info(f"Successfully converted PDF to Markdown ({len(conversion_result.markdown)} chars)")
            ...
            try:
                logger.warning("Attempting fallback conversion without structured output")
