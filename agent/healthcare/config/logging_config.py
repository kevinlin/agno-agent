...
def configure_logger_levels() -> None:
    ...
    logging.getLogger("agent.healthcare").setLevel(logging.INFO)

    # Database and storage - moderate verbosity
    logging.getLogger("agent.healthcare.storage").setLevel(logging.INFO)
    logging.getLogger("agent.healthcare.search").setLevel(logging.INFO)

    # Agent and AI - detailed for debugging
    logging.getLogger("agent.healthcare.agent").setLevel(logging.DEBUG)
    logging.getLogger("agent.healthcare.conversion").setLevel(logging.INFO)
